...
void incrprob_s_l(int x, long *q, int *t);
void incrprob_u_l(unsigned x, long *q, int *t);
void incrprob_sl_l(long x, long *q, int *t);
void incrprob_ul_l(unsigned long x, long *q, int *t);
